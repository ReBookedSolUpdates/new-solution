...
const CATEGORY_PAGES: CategoryPageData[] = [
  {
    ...
    highlights: [
      ...
      {
        title: "Price fairly by condition",
        description: "Like-new textbooks can command full price. Heavy notes or water damage warrants a deeper discount to reflect realistic value.",
    ...
    listingChecklist: [
      ...
      "Note the publication year and edition so buyers confirm compatibility with their course.",
      "Mention any specific markings, dog ears, or cosmetic wear that affects appearance.",
      "State whether the book has been kept in a bag, locker, or shelf (basement books may smell different).",
    ],
    buyerChecklist: [
      ...
      "Compare the price against new textbooks online to judge savings.",
      "Check the seller's rating and ask questions if photos are unclear.",
      "Verify the book's status with your school — some require annotation permissions.",
    ],
    examples: [
      ...
      "Organic Chemistry textbook (4th edition), spine intact, no water damage, sold as complete set with solutions manual.",
      "Used IEB English Literature anthology with study notes and marginal highlights, great for revision.",
    ],
    shippingTips: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Season and type matter",
        description: "Distinguish between winter and summer uniforms, formal and sports wear. Different occasions require different fits.",
        icon: <Shirt className="h-5 w-5 text-book-700" />,
      },
    ],
    listingChecklist: [
      ...
      "Note any repairs, patching, fading, or badge damage so buyers see exactly what they're getting.",
      "Include fabric type and care notes if relevant (dry clean only, machine washable, etc).",
      "Specify the school year or form for secondary uniforms, as some schools change uniform codes.",
    ],
    buyerChecklist: [
      ...
      "Verify this is the correct uniform for your school year (some schools change designs).",
      "Check fading levels in photos — some uniforms pale after heavy washing.",
      "Ask about last wash date if care is important for your use case.",
    ],
    examples: [
      ...
      "Summer dress (Grade 10) with perfect condition crest and hem, size 6.",
      "Complete first-term sports kit for boys: hockey shirt and shorts, all branded, excellent condition.",
    ],
    shippingTips: [
  ...
  },
  {
    ...
    highlights: [
      ...
      {
        title: "Condition and completeness",
        description: "Specify if all pieces are present, whether items are new/sealed/used, and if there are missing batteries or refills.",
        icon: <CheckCircle2 className="h-5 w-5 text-book-700" />,
      },
    ],
    listingChecklist: [
      ...
      "Specify handedness for sports equipment (left-handed or right-handed gear matters).",
      "Include any warranty or certificate of authenticity if applicable (e.g., calculator guarantees).",
    ],
    buyerChecklist: [
      ...
      "Verify warranty or instruction manuals are included if they were new originally.",
      "For art or tech kits, confirm all components are present (especially for bundled sets).",
      "Check whether consumables like batteries, ink, or refills are included in the price.",
    ],
    examples: [
      ...
      "Geometry set (compass, protractor, ruler, set square) all present with zip case.",
      "Complete stationery pack: pens, pencils, erasers, sharpener, and filing materials.",
      "Tennis racket with grip (size appropriate for Grade 8), head cover included.",
    ],
    shippingTips: [
