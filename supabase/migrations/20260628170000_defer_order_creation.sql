-- Migration: Defer Order Creation until Successful Payment Confirmation
-- Created: 2026-06-28

-- 1. Create/Update create_order_with_wallet_deduction to handle intents vs orders
...
-- 2. Create the materialize_order_from_intent RPC function
...
BEGIN
    ...
    IF v_wallet_deducted_amount > 0 THEN
        ...
        -- Note: transaction log is created below with the materialized order reference
    END IF;
